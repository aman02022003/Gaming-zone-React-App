...
const Videos = () => {
 ...
 const [vsrc,setvsrc]= useState(videosArr[0])

  return (
  <Stack direction={["column","row"]} h={'100vh'}>
     
    <VStack w={'full'}>
       <video src={vsrc}controls controlsList='nodownload' style={{
        width: '100%',
       }}></video>
...

{
      ...
      videosArr.map((item, index) => {
         return <Button variant={'ghost'} colorScheme='orange' onClick={()=>setvsrc(item)}>
            Video {index+1}
          </Button>   
      })
    }
